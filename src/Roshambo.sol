...
contract Roshambo is ERC721, Multicall, Owned, Pausable, IERC4906, IRoshambo {
    ...
    // | _ownerOf         | mapping(uint256 => address)                  | 2    | 0      | 32    |
    // | _balanceOf       | mapping(address => uint256)                  | 3    | 0      | 32    |
    // | getApproved      | mapping(uint256 => address)                  | 4    | 0      | 32    |
    // | isApprovedForAll | mapping(address => mapping(address => bool)) | 5    | 0      | 32    |
    // | owner            | address                                      | 6    | 0      | 20    |
    // | _paused          | bool                                         | 6    | 20     | 1     |
    // | beneficiary      | address                                      | 7    | 0      | 20    |
    // | rake             | uint16                                       | 7    | 20     | 2     |
    // | currentId        | uint40                                       | 7    | 22     | 5     |
    // | totalSupply      | uint40                                       | 7    | 27     | 5     |
    // | games            | mapping(uint40 => struct Game)               | 8    | 0      | 32    |
    // | balances         | mapping(address => uint256)                  | 9    | 0      | 32    |
    // |-----------------------------------------------------------------------------------------|
    ...
    ) payable ERC721("Roshambo", "ROSHAMBO") Owned(msg.sender) {
